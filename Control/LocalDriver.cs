...
{
    public class LocalDriver : IWebDriver
    {
        ...
        public LocalDriver(string firefoxHome)
        {
            if (_driver == null)
            {
                FirefoxDriverService service = FirefoxDriverService.CreateDefaultService(firefoxHome);
                service.FirefoxBinaryPath = firefoxHome+@"\firefox.exe";
